...
const Nav = () => {
    ...
    return (
        <nav className={`h-20 bg-white no-underline flex items-center ${menuVisible ? 'border-b-0' : ''} relative border-b-2`}>
            ...
            <div id="navLinks" className={`absolute  md:static ${menuVisible ? 'block' : 'hidden'} md:flex pl-[30%] min-h-full top-0 right-0 bottom-0 left-0 md:h-20 z-10 md:z-0  w-full items-center   `}>
